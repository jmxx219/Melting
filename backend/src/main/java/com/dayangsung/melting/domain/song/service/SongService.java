...
public class SongService {
	...
	private static final String STREAMING_COUNT_KEY_PREFIX = "song:streaming:";
	...
	public SongDetailsResponseDto getSongDetails(Long songId) {
		...
		String streamingCountKey = STREAMING_COUNT_KEY_PREFIX + songId;
		redisTemplate.opsForValue().increment(streamingCountKey);
